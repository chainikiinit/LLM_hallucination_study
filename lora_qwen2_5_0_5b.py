"""
замеры Qwen2.5-0.5b + LoRA на едином бенчмарке
"""
...
dataset_path = "data_results/step1_res/Qwen2.5_0.5b_results_4k.csv"
...
def loading_model():
    model_path = "./model_qwen2_5_0_5b"  # локальный путь
...
model_path = "model_qwen2_5_0_5b"
adapters = [
    "lora_models/Qwen2.5_0.5b_att", 
    "lora_models/Qwen2.5_0.5b_attmlp", 
    "lora_models/Qwen2.5_0.5b_mlp"
]

import warnings
warnings.filterwarnings('ignore')

save_path = "data_results/step1_res/Qwen2.5_0.5b_results_4k.csv"
...
for m in range(len(models_list)):
    for i in attempt_list:
        for adapter in adapters:
            ...
            if adapter == "lora_models/Qwen2.5_0.5b_att":
                answer_col = f"{models_list[m]}_att_{i}"
            elif adapter == "lora_models/Qwen2.5_0.5b_attmlp":
                answer_col = f"{models_list[m]}_attmlp_{i}"
            elif adapter == "lora_models/Qwen2.5_0.5b_mlp":
