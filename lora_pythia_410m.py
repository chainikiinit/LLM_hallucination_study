"""
замеры Pythia-410m + LoRA на едином бенчмарке
"""
...
dataset_path = "data_results/step1_res/Pythia_410m_results_4k.csv"
...
model_path = "model_pythia_410m"
adapters = [
    "lora_models/Pythia_410m_att", 
    "lora_models/Pythia_410m_attmlp", 
    "lora_models/Pythia_410m_mlp"
]

import warnings
warnings.filterwarnings('ignore')

save_path = "data_results/step1_res/Pythia_410m_results_4k.csv"
...
for m in range(len(models_list)):
    for i in attempt_list:
        for adapter in adapters:
            ...
            if adapter == "lora_models/Pythia_410m_att":
                answer_col = f"{models_list[m]}_att_{i}"
            elif adapter == "lora_models/Pythia_410m_attmlp":
                answer_col = f"{models_list[m]}_attmlp_{i}"
            elif adapter == "lora_models/Pythia_410m_mlp":
