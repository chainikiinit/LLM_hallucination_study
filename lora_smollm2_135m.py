"""
замеры SmolLM2-135m + LoRA на едином бенчмарке
"""
...
dataset_path = "data_results/step1_res/SmolLM2_135m_results_4k.csv"
...
def loading_model():
    model_path = "./model_smollm2_135m"  # локальный путь
...
models_list = ["SmolLM2_135m"]

attempt_list = [1]

model_path = "model_smollm2_135m"
adapters = [
    "lora_models/SmolLM2_135m_att", 
    "lora_models/SmolLM2_135m_attmlp", 
    "lora_models/SmolLM2_135m_mlp"
]

import warnings
warnings.filterwarnings('ignore')

save_path = "data_results/step1_res/SmolLM2_135m_results_4k.csv"
...
for m in range(len(models_list)):
    for i in attempt_list:
        for adapter in adapters:
            ...
            if adapter == "lora_models/SmolLM2_135m_att":
                answer_col = f"{models_list[m]}_att_{i}"
            elif adapter == "lora_models/SmolLM2_135m_attmlp":
                answer_col = f"{models_list[m]}_attmlp_{i}"
            elif adapter == "lora_models/SmolLM2_135m_mlp":
